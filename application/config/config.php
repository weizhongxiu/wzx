...
$config['static_path'] = $config['base_url']."assets/";
$config['js_url'] = $config['static_path'] . "js/";
$config['css_url'] = $config['static_path'] . "css/";
$config['img_url'] = $config['static_path'] . "img/";
